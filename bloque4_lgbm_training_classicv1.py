...
MODEL_OUTPUT_PATH = f'gs://{BUCKET}/modelos/modelo_lgbm.txt'
...
print("📁 Guardando modelo entrenado en el bucket...")
model.save_model('modelo_lgbm.txt')
with fs.open(MODEL_OUTPUT_PATH, 'wb') as f:
    with open('modelo_lgbm.txt', 'rb') as f_local:
        f.write(f_local.read())
print("✅ Modelo guardado en GCS:", MODEL_OUTPUT_PATH)
